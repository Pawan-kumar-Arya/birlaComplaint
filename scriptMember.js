...
import { getDatabase, ref, set, get, push, remove,update,onValue, child} from "https://www.gstatic.com/firebasejs/11.0.1/firebase-database.js";
import { getAuth,deleteUser, updateEmail, EmailAuthProvider, reauthenticateWithCredential,createUserWithEmailAndPassword,sendEmailVerification,updatePassword } from "https://www.gstatic.com/firebasejs/11.0.1/firebase-auth.js";
...
document.getElementById('change-password-form')?.addEventListener('submit', async (event) => {
    ...
    if (!checkPasswordMatch()) return; // Ensure new passwords match
    ...
    try {
       ...
       const membersRef = ref(database, 'members/' + user.uid);
        ...
        await update(membersRef, { password: newPassword });
        console.log("✅ Password updated in Firebase Realtime Database!");

        alert("✅ Password updated successfully in both Authentication & Database!");
